            ...
            <div class="card-body">
                <div class = "d-flex justify-content-between">
                    ...
                    <div class="pull-right d-flex justify-content-end m-3" >
                        <a class="btn btn-primary  mb-2" href="{{ route('workers.create') }}"><i class="fa fa-plus"></i> Ստեղծել նոր աշխատակից/այցելու</a>
                    </div>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown action"data-id="{{ $person->id }}" data-tb-name="people">
                                        ...
                                        @endif
                                            ...
                                            <a class="dropdown-item" href="{{route('workers.edit',$person->id)}}"><i
