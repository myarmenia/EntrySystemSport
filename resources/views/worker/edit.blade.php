...
// ✅ worker হলে type-ը ֆիքսված կլինի
$isWorkerFixed = ($person && $person->type === 'worker');
@endphp
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('workers.list') }}">Աշխատակիցների ցանկ</a></li>
                                    <li class="breadcrumb-item active">Խմբագրել</li>
                                </ol>
                            </nav>
                        </h5>

                        <form action="{{ route('workers.update', $person->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @else
                                        <select class="form-select" name="type">
                                            ...
                                            <option value="worker" {{ $person->type=="worker" ? 'selected' : '' }}>Աշխատող</option>
                                            <option value="visitor" {{ $person->type=="visitor" ? 'selected' : '' }}>Այցելու</option>
                                        </select>
                                    @endif
